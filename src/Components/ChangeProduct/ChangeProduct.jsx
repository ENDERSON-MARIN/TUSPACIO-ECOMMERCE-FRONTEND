...
export default function ChangeProduct({id, setOneProduct}) {
                    ...
                    >
                        <div key='divName'>
                            <TextField
                                ...
                                label="Name"
                                // value={input.name}
                                defaultValue={product.dbInfo.name}
                        ...
                        <div key='divBrand'>
                            <FormControl variant="filled" className={classes.formControl}>
                                ...
                                <Select
                                    ...
                                    name="brand"
                                    defaultValue={product.dbInfo.brand}
                                    // value={input.brand}
                                    onChange={(e) => handleChange(e)}
                                >
                    ...
                    >
                        <Box className={classes.range} key={`divPrice`}>
                            <TextField
                                ...
                                type="number"
                                defaultValue={product.dbInfo.price}                                
                                min={0}
                                name="price"
                                // value={input.price}
                                onChange={(e) => handleChange(e)}
                        ...
                        <div key='divStock'>
                            <TextField
                                ...
                                id="outlined-helperText"
                                type="number"
                                defaultValue={product.dbInfo.stock}                                
                                min={0}
                                name="stock"
                                label="Stock"
                                // value={input.stock}
                        ...
                        <Box key='divStock'>
                            <FormControl variant="filled" className={classes.formControl}>
                                ...
                                <Select
                                    native
                                    className={classes.select}
                                    defaultValue={product.dbInfo.product_type}                                
                                    name="product_type"
                    ...
                    >
                        <Box key='divImg'>
                            <TextField
                                ...
                                name="image_link"
                                label="Image URL"
                                defaultValue={product.dbInfo.image_link}                                
                    ...
                    >
                        <Box className='typeBox' key='divDesc'>
                            <TextField
                                ...
                                name="description"
                                label="Description"
                                defaultValue={product.dbInfo.description}                                
                        ...
                        <Box className={classes.rating} key={`divRating`}>
                            ...
                            <Slider
                                ...
                                defaultValue={parseInt(product.dbInfo.rating)}                                
